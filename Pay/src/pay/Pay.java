...
public class Pay
{
    public static void main(String[] args) throws Exception 
    {
        ...
        double payRate;
        double medical = 0, dental = 0, disability = 0, retirement = 0, totalDeductions;
        int medOption = 0, dentOption = 0, disOption = 0, retOption = 0;
        ...
        entry = JOptionPane.showInputDialog(null, "Please enter skill level - 1, 2, or 3");
        level = Integer.parseInt(entry);
        entry = JOptionPane.showInputDialog(null, "Please enter hours worked");
        ...
        if(level == 2 || level == 3)
        {
           entry = JOptionPane.showInputDialog(null, "Do you want the medical insurance?\n" +
           ...
           if(level == 3)
           {
               entry = JOptionPane.showInputDialog(null, "Do you wnat the retirement plan?\n"
